...
@Slf4j
@Setter
public class StrongerDataEncryptionImpl implements DataEncryption {

    private static StrongerDataEncryptionImpl dataEncryption;
    private KeyPair keyPair;
    private SecretKey secretKey = generateSecretKey();
    private int AES_KEY_SIZE = 2048;
    private int RSA_KEY_SIZE = 2048;

    private StrongerDataEncryptionImpl() throws Exception {
    }

    public static StrongerDataEncryptionImpl getInstance() throws Exception {
        synchronized (StrongerDataEncryptionImpl.class){
            if(dataEncryption==null)
                dataEncryption = new StrongerDataEncryptionImpl();
        }
